const levelData = {
    1: {
        ...
        items: {
            ...
            'C': [{ name: 'Cirkus', emoji: '🎪' }, { name: 'Cola', emoji: '🥤' }, { name: 'Candy', emoji: '🍬' }, { name: 'Cykel', emoji: '🚲' }, { name: 'Camel', emoji: '🐫' }],
            ...
            'X': [{ name: 'Xylofon', emoji: '🎹' }, { name: 'X-ray', emoji: '🩻' }],
            'Q': [{ name: 'Quiz', emoji: '❓' }, { name: 'Quiche', emoji: '🥧' }],
            'Æ': [{ name: 'Ærfugl', emoji: '🦆' }],
