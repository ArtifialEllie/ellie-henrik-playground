const levelData = {
    1: {
        ...
        items: {
            ...
            'Z': [{ name: 'Zebra', emoji: '🦓' }, { name: 'Zipp', emoji: '🤐' }, { name: 'Zulu', emoji: '🇿🇼' }],
            'W': [{ name: 'Waffle', emoji: '🧇' }, { name: 'Web', emoji: '🕸️' }, { name: 'Wifi', emoji: '📶' }],
            'X': [{ name: 'Xylofon', emoji: '🎹' }, { name: 'X-ray', emoji: '🩻' }, { name: 'Xenia', emoji: '👩' }],
            'Q': [{ name: 'Quiz', emoji: '❓' }, { name: 'Quiche', emoji: '🥧' }, { name: 'Qatar', emoji: '🇶🇦' }],
