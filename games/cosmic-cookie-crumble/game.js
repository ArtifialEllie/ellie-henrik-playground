...
class GoldenCookie {
    constructor() {
        ...
        this.life = 300; // Frames it stays on screen
    }
...
function handleInput(e) {
    ...
    // Check if Golden Cookie was clicked (even if outside the main cookie)
    if (goldenCookie) {
...
function gameLoop() {
    ...
    // Golden Cookie Logic
    if (!goldenCookie && Math.random() < 0.002) {
    ...
    if (goldenCookie && goldenCookie.life <= 0) {
        goldenCookie = null;
    }
